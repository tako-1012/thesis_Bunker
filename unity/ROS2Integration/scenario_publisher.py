...
class ScenarioPublisher(Node):
    def __init__(self):
        ...
        # シナリオデータ読み込み
        self.scenarios_path = Path(__file__).parent.parent.parent / 'ros2/ros2_ws/src/bunker_ros2/simulation_manager/scenarios'
        self.scenarios = self.load_scenarios()
        
        self.get_logger().info(f'Scenario Publisher started with {len(self.scenarios)} scenarios')
